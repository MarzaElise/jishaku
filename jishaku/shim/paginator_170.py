...
"""
jishaku.paginators (shim for diskord 1.7.x)
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
class PaginatorInterface:  # pylint: disable=too-many-instance-attributes
    ...
    async def wait_loop(self):  # pylint: disable=too-many-branches, too-many-statements
        ...
        def check(payload: diskord.RawReactionActionEvent):
            """
            ...
            emoji = payload.emoji
            if isinstance(emoji, diskord.PartialEmoji) and emoji.is_unicode_emoji():
                emoji = emoji.name
        ...
        try:  # pylint: disable=too-many-nested-blocks
            ...
            while not self.bot.is_closed():
                ...
                for task in done:
                    ...
                    if isinstance(payload, diskord.RawReactionActionEvent):
                        emoji = payload.emoji
                        if isinstance(emoji, diskord.PartialEmoji) and emoji.is_unicode_emoji():
                            emoji = emoji.name
            ...
            for emoji in filter(None, self.emojis):
                ...
                except (diskord.Forbidden, diskord.NotFound):
                    pass
