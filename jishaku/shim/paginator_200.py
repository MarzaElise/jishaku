...
"""
jishaku.paginators (shim for diskord 2.0.0)
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
class PaginatorInterface(ui.View):  # pylint: disable=too-many-instance-attributes
    ...
    def send_kwargs(self) -> dict:
        ...
        As this must be compatible with both `diskord.TextChannel.send` and `diskord.Message.edit`,
    ...
    async def send_to(self, destination: diskord.abc.Messageable):
        """
    ...
    async def interaction_check(self, interaction: diskord.Interaction):
    ...
    @ui.button(label="1 \u200b \N{BLACK LEFT-POINTING DOUBLE TRIANGLE WITH VERTICAL BAR}", style=diskord.ButtonStyle.secondary)
    async def button_start(self, button: ui.Button, interaction: diskord.Interaction):  # pylint: disable=unused-argument
    ...
    @ui.button(label="\N{BLACK LEFT-POINTING TRIANGLE}", style=diskord.ButtonStyle.secondary)
    async def button_previous(self, button: ui.Button, interaction: diskord.Interaction):  # pylint: disable=unused-argument
    ...
    @ui.button(label="1", style=diskord.ButtonStyle.primary)
    async def button_current(self, button: ui.Button, interaction: diskord.Interaction):  # pylint: disable=unused-argument
        """Button to refresh the interface"""

        self.update_view()
        await interaction.response.edit_message(**self.send_kwargs)

    @ui.button(label="\N{BLACK RIGHT-POINTING TRIANGLE}", style=diskord.ButtonStyle.secondary)
    async def button_next(self, button: ui.Button, interaction: diskord.Interaction):  # pylint: disable=unused-argument
    ...
    @ui.button(label="\N{BLACK RIGHT-POINTING DOUBLE TRIANGLE WITH VERTICAL BAR} \u200b 1", style=diskord.ButtonStyle.secondary)
    async def button_last(self, button: ui.Button, interaction: diskord.Interaction):  # pylint: disable=unused-argument
    ...
    @ui.button(label="\N{BLACK SQUARE FOR STOP} \u200b Close paginator", style=diskord.ButtonStyle.danger)
    async def button_close(self, button: ui.Button, interaction: diskord.Interaction):  # pylint: disable=unused-argument
...
class PaginatorEmbedInterface(PaginatorInterface):
    ...
    def __init__(self, *args, **kwargs):
        self._embed = kwargs.pop('embed', None) or diskord.Embed()
